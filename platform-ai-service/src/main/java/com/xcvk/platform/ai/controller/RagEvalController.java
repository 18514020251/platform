...
public class RagEvalController {
    ...
    public RagEvalDatasetVO createDataset(@Valid @RequestBody RagEvalDatasetCreateRequest request) {
        return ragEvalService.createDataset(request);
    }
    ...
    public List<RagEvalDatasetVO> listDatasets(@RequestParam(required = false) Long categoryId,
                                               @RequestParam(required = false) Integer limit) {
        return ragEvalService.listDatasets(categoryId, limit);
    }
    ...
    public RagEvalRunVO runEvaluation(@Valid @RequestBody(required = false) RagEvalRunRequest request) {
        return ragEvalService.runEvaluation(request);
    }
    ...
    public List<RagEvalRunVO> listRuns(@RequestParam(required = false) Integer limit) {
    ...
    public List<RagEvalCaseResultVO> listCaseResults(@PathVariable("runId") Long runId) {
        return ragEvalService.listCaseResults(runId);
    }
}